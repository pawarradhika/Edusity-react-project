        ...
        <ul ref={slider}>
          <li>
            <div className="slide">
              ...
              <p>Choosing to purse my degree at Edusity was one of the best desicion I've ever made. The supportive community, state-of-the-art facilities, and commitment to academic excellence have truly exceeded my expectations.</p>
            </div>
          </li>
          <li>
            <div className="slide">
