...
<ul>
  <li><img src={mail_icon} alt=""/>ontact@edusity.dev </li>
  <li><img src={phone_icon} alt=""/>+91 889-456-9877</li>
  <li><img src={location_icon} alt=""/>89 Massachusetts Ave, Cambridge<br/> MA 02139, United States</li>
</ul>
      </div>
       <div className="contact-col">
